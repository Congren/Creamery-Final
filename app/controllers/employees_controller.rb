class EmployeesController < ApplicationController
  ...
  def index
    !authorize! :read, @active_employees
  ...
  def show
    @past_shifts = @employee.shifts.past
    @upcoming_shifts = @employee.shifts.upcoming
  ...
  def employee_params
    params.require(:employee).permit(:first_name, :last_name, :ssn, :date_of_birth, :role, :phone, :active,user_attributes: [:email, :password, :password_confirmation, :employee_id, :_destroy])
  end
